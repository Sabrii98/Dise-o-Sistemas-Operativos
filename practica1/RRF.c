...
/* Declaramos las colas que se van a utilizar: una de alta prioridad y otra de baja prioridad */
...
void init_mythreadlib() {
  int i;
  /* Inicializamos las colas de alta prioridad y de baja prioridad */
