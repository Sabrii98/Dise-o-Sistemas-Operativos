...
/* Search an element and remove it from queue if found. This function can be specialized for comparing the contents of structures s->data and data instead of pointers to structures */
